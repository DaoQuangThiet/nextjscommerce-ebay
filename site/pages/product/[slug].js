...
import commerce, {testApi} from "@lib/api/commerce";
                            ...
                            <Grid container direction="row" lg={12}>
                                ...
                                <Grid item xs={12} sm={12} md={6} lg={6} >
                                    <div className='descDetail'>
                                        ...
                                        <h3 className={classes.priceproduct}>${product.price.value}</h3>
                                        <div
                                        ...
                                        <div className={classes.product_meta}>
                                            ...
                                            {!isEmpty(product.collections) ? (
                                                <CategoriesCarousel gallery={product.collections} />
                                                ...
                                                <div className={classes.box_product}>
                                                    ...
                                                    <div className={classes.cardBody}>
                                                        ...
                                                        <h4 className={classes.cardPrice}>
                                                            <span className={classes.price_sales}>${item.price.value}</span>
                                                        </h4>
                                                    </div>
                                                </div>
                                            </div>
...
export async function getStaticProps({
    ...
    const testPromise = await testApi();

    // if (testPromise.ok) {
    //     const test = await testPromise.json();
